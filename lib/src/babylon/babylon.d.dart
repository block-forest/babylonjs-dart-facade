...
class SceneLoader {
  ...
  external static void set ForceFullSceneLoadingForIncremental(bool v);
...
@JS()
class Ribbon extends Primitive {
...
@JS()
class TiledGround extends Primitive {
...
class InstancesBatch {
  external factory InstancesBatch();
