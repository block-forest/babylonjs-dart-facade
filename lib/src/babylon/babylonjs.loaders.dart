@JS()
library typescript.babylonjs.loaders;
...
abstract class JS$_ILoaderImage implements IImage, JS$_IArrayItem {
  external Promise<Blob> get JS$_blob;
  external set JS$_blob(Promise<Blob> v);
  external factory JS$_ILoaderImage({Promise<Blob> JS$_blob, num JS$_index});
}
...
abstract class GLTF2_GLTFLoaderExtension
  ...
  external Nullable<Promise<Null>> JS$_loadTextureAsync(
      String context, ITextureInfo textureInfo, void assign(Texture texture));
...
@JS("BABYLON.GLTF2.Extensions.KHR_texture_transform")
class KHR_texture_transform extends GLTF2_GLTFLoaderExtension {
  // @Ignore
  KHR_texture_transform.fakeConstructor$() : super.fakeConstructor$();
  external String get name;
  external set name(String v);
  external Nullable<Promise<Null>> JS$_loadTextureAsync(
      String context, ITextureInfo textureInfo, void assign(Texture texture));
